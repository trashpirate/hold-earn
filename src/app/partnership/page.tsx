    ...
    return (
        <section className="flex flex-col justify-start h-screen pt-28 sm:pt-36 ">
            ...
            <div className="flex flex-col mx-auto rounded-2xl border-2 border-primary p-6 sm:p-8 w-full max-w-3xl mt-4 mb-16">
                <Link className="w-full max-w-3xl rounded-2xl mb-8" href="https://forms.gle/N1RFtESwo8ZeXZ2KA">
                    <Image
                ...
                <div className='flex flex-row w-full justify-center align-middle mt-8 mb-4'>
                    <Link href="https://forms.gle/N1RFtESwo8ZeXZ2KA" className='leading-6 text-md md:text-lg text-black bg-primary px-4 py-2 cursor-pointer rounded-xl font-bold my-auto duration-500 hover:scale-110 transform'>
