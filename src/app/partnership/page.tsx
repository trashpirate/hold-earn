            ...
            <div className="flex flex-col justify-start mx-4">
                ...
                <div className="flex flex-col mx-auto rounded-2xl border-2 border-primary p-6 sm:p-8 w-full max-w-3xl mt-4 mb-16">
                    ...
                    <ol className="list-decimal  text-white/50 font-thin list-outside ml-8 sm:ml-10 text-sm md:text-lg">
                        ...
                        <li className="leading-7">LP must be burned or locked.</li>
                        ...
                        <li className="leading-7">Optional: Provide any amount of your token (we suggest at least 0.5 ETH worth or 0.5% of the supply) to be airdropped to our <a href="https://app.buyholdearn.com/" className="text-primary/70 hover:text-primary">Flame NFT</a> holders.</li>
                    </ol>
