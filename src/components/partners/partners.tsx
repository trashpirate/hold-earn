        ...
        <section className='my-36 px-7 flex justify-center scroll-m-36'>
            <div className='max-w-7xl w-full flex justify-center flex-col'>
                <div className='flex justify-center'>
                    <h1 className='text-4xl font-bold'>LISTINGS & PARTNERS</h1>
                </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-16 my-16 align-middle justify-center'>
                    ...
                    <Link className="m-auto" href="https://coinmarketcap.com/currencies/buyholdearn/">
                        <Image
                            className='h-auto w-36 justify-self-center my-auto'
