...
export default function Copy2Clipboard(props: { text: string; copyText: string; textColor: string; textSize: string; iconSize: string }) {
    ...
    return (
        <div className="flex flex-row hover:cursor-pointer opacity-60 hover:opacity-100 transition-all duration-100 w-full justify-end h-8 pt-1 my-auto">
